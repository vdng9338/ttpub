...
[#assign homeURL        =  "${prodPath}"]
[#assign homeIMG        =  "http://www.cityofmadison.com/residents/images/bus.jpg"]
[#assign busURL         =  "${prodPath}/Schedules/RoutesSchedules/RoutesSchedules.html"]
[#assign lightRailURL   =  ""]
[#assign railURL        =  ""]
[#assign faresURL       =  "${prodPath}/Fares/FarePage/Fares.htm"]
[#assign mapURL         =  "${prodPath}/Schedules/RoutesSchedules/RoutesSchedules.html"]
[#assign tripPlannerURL =  "http://trip.cityofmadison.com/"]
[#assign alertsURL      =  "${prodPath}/Detours/DetourMainPage.htm"]
[#assign alertsPHONE    =  "(608)266-4466"]
[#assign stopsURL       =  "${prodPath}/BusStopDepartures/BusStopDepartures.htm"]
[#assign stopDetailURL  =  "${prodPath}/PopularDestinations/PopularDestinations.htm"]
[#assign howToRideURL   =  "${prodPath}/HowToRide/HowToRide/HowtoRide.htm"]
[#assign helpURL        =  "${howToRideURL}"]
[#assign storeURL       =  "http://billready.com/COM/MetroBusPass.aspx"]
[#assign spacerLINE             =  "<img src='http://www.capmetro.org/images/footer_line.gif' width='379' height='14'/>"]
[#assign agencyNAME             = "Metro Transit"]
[#assign agencyFullNAME         = "City of Madison Metro Transit"]
[#assign agencyAddressLineONE   = "1101 E. Washington Ave. |  Madison, WI 53703 | (608) 266-4466"]
[#assign agencyAddressLineTWO   = "TTY/Textnet: (866) 704-2316 | mymetrobus@cityofmadison.com"]
